...
Nous avons donc choisis de passer à une architecture plus simple : pas d'héritage, et simplement une map globale faisant la liaison entre le nom des instructions Xsl
