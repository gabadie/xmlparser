...
namespace Xsl
{
    ...
    /**
     * Finds the template that matches the most the given context element.
     *
     ...
     *
     * @return the best matching XSL template if any, otherwise returns nullptr
     */
    std::vector<Xml::Node *>
     ...
     *
     * @param context the context where the template is applied
     * @param xslDoc the XSL document that is used for the transformation
     * @param xslTemplate the XSL template that will be applied
     *
